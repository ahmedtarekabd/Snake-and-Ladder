...
int Input::GetInteger(Output *pO) const 
{
	...
	return n; // this line should be changed with your implementation
}
...
{	
	...
	else	
	{
		...
		return STATUS;	// just for now ==> This should be updated * Done *
